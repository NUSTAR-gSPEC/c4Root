#ifndef gPlastReader_H
#define gPlastReader_H
...
struct EXT_STR_h101_gplast_t;
typedef struct EXT_STR_h101_gplast_t EXT_STR_h101_gplast;
typedef struct EXT_STR_h101_gplast_onion_t EXT_STR_h101_gplast_onion;
class ext_data_struct_info;


struct gplast_last_lead_hit_struct{
    bool hit = false;
...
class gPlastReader : public c4Reader
{
    public:
        gPlastReader(EXT_STR_h101_gplast_onion*, size_t);

        virtual ~gPlastReader();
        ...
        static int GetNumberOfTAMEXBoards() {return NBoards;};

    private:
        Int_t fNEvent;
        int total_time_microsecs = 0;

        EXT_STR_h101_gplast_onion* fData;
        ...
        static const int NBoards = sizeof(fData->gplast_tamex) / sizeof(fData->gplast_tamex[0]);
    ...
    public:
        ClassDefOverride(gPlastReader, 0);
};
