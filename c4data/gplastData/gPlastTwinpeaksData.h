#ifndef gPlastTwinpeaksData_H
#define gPlastTwinpeaksData_H

#include "TObject.h"

class gPlastTwinpeaksData : public TObject
{
    public:
        // Default Constructor
        gPlastTwinpeaksData();
    ...
    public:
        ClassDef(gPlastTwinpeaksData, 1);
};
